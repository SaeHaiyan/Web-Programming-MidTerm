                ...
                <div class="card-body d-flex">
                    <div class="col-md-7 text-left space-mono text-container">
                        ...
                        <div class="button-group">
                            <a href="{{ route('admin.rentals1.index') }}" class="btn main-menu-btn" style="background-color: #26355D; color: white;">Rentals</a>
                            <a href="{{ route('admin.customers1.index') }}" class="btn main-menu-btn" style="background-color: #FF8F00; color: black;">Customers</a>
                            <a href="{{ route('admin.games1.index') }}" class="btn main-menu-btn" style="background-color:#FF8F00; color: black;">Games</a>
                        </div>
                    </div>
