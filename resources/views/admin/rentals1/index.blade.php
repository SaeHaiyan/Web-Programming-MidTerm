...
<div class="container mb-5 p-4" style="background-color: rgba(0, 0, 0, 0.7); border-radius: 15px; box-shadow: 0 0 10px rgba(0,0,0,0.5);">
    <a href="{{ route('admin.rentals1.create') }}" class="btn" style="background-color:#FF8F00; color: black; width: 100%; padding: 15px; font-family: 'Press Start 2P', cursive; margin-bottom: 20px;">Add Rentals</a>
        ...
        <tbody>
            @foreach($rentals as $rental)
                <tr style="background-color: #555;">
                    ...
                    <td> 
                        <a href="{{ route('admin.rentals1.show', $rental->id) }}" class="btn" style="background-color:#FF204E; color: black;">View</a>
                        <a href="{{ route('admin.rentals1.edit', $rental->id) }}" class="btn" style="background-color: #FF204E; color: black;">Edit</a>
                        <form action="{{ route('admin.rentals1.destroy', $rental->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
