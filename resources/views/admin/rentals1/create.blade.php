...
<div class="container mt-5">
    ...
    <div class="card mx-auto" style="max-width: 600px;"> <!-- Center the card and limit its width -->
        <div class="card-body" style="background-color: rgba(255, 255, 255, 0.8);"> <!-- Card body for form padding -->
            <form action="{{ route('admin.rentals1.store') }}" method="POST" onsubmit="return showSuccessMessage()">
                @csrf
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('admin.rentals1.index') }}" class="btn" style="background-color: #FF204E; color: black; width: 48%; font-family: 'Press Start 2P', cursive; padding: 15px; font-size: 20px;">Back</a>
