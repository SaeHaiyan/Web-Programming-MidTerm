...
<div class="container mb-5">
    <div class="p-4 border border-secondary rounded shadow-lg" style="background-color: rgba(0, 0, 0, 0.7); color: white;"> <!-- Container styling -->
        ...
        <form action="{{ route('admin.rentals1.update', $rental->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-between mt-4"> <!-- Flexbox for buttons -->
                <a href="{{ route('admin.rentals1.index') }}" class="btn" style="background-color: rgb(5, 130, 175); color: white; width: 48%; padding: 15px; font-family: 'Press Start 2P', cursive;">
